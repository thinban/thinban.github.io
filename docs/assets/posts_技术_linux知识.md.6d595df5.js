import{_ as s,o as n,c as a,Q as e}from"./chunks/framework.7705da0e.js";const m=JSON.parse('{"title":"Linux相关","description":"摘抄","frontmatter":{"title":"Linux相关","description":"摘抄","date":"2023-12-14T00:00:00.000Z","tags":["计算机科学"]},"headers":[],"relativePath":"posts/技术/linux知识.md","filePath":"posts/技术/linux知识.md"}'),p={name:"posts/技术/linux知识.md"},l=e(`<h2 id="linux启动过程" tabindex="-1">linux启动过程 <a class="header-anchor" href="#linux启动过程" aria-label="Permalink to &quot;linux启动过程&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">linux启动过程分析</span></span>
