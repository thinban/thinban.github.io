import{_ as s,o as n,c as a,Q as e}from"./chunks/framework.1eb6b028.js";const g=JSON.parse('{"title":"设计模式","description":"20240426_设计模式","frontmatter":{"title":"设计模式","description":"20240426_设计模式","date":"2024-04-26T00:00:00.000Z","tags":["设计模式"]},"headers":[],"relativePath":"posts/知识整理/20240426_设计模式.md","filePath":"posts/知识整理/20240426_设计模式.md"}'),l={name:"posts/知识整理/20240426_设计模式.md"},p=e(`<h1 id="设计模式的六大原则" tabindex="-1">设计模式的六大原则 <a class="header-anchor" href="#设计模式的六大原则" aria-label="Permalink to &quot;设计模式的六大原则&quot;">​</a></h1><p>对接口编程而不是对实现编程。</p><p>优先使用对象组合而不是继承。</p><p>设计模式的使用（solid）</p><ul><li>单一职责(Single Responsibility)</li><li>开闭原则（Open Close Principle）:对扩展开放，对修改关闭</li><li>里氏代换原则（Liskov Substitution Principle）：继承复用,子类替代父类出现。</li><li>迪米特法则（Law Of Demeter Principle）：一个实体应当尽量少地与其他实体之间发生相互作用，使得系统功能模块相对独立。</li><li>接口隔离原则（Interface Segregation Principle）：使用多个隔离的接口，比使用单个接口要好</li><li>依赖倒转原则（Dependence Inversion Principle）：针对接口编程，依赖于抽象而不依赖于具体。</li><li>合成复用原则（Composite Reuse Principle）：尽量使用合成/聚合的方式，而不是使用继承。</li></ul><h1 id="创建型模式" tabindex="-1">创建型模式 <a class="header-anchor" href="#创建型模式" aria-label="Permalink to &quot;创建型模式&quot;">​</a></h1><h2 id="工厂模式-factory-pattern" tabindex="-1">工厂模式（Factory Pattern） <a class="header-anchor" href="#工厂模式-factory-pattern" aria-label="Permalink to &quot;工厂模式（Factory Pattern）&quot;">​</a></h2><p>//见抽象工厂模式，已包含其原理</p><h2 id="抽象工厂模式-abstract-factory-pattern" tabindex="-1">抽象工厂模式（Abstract Factory Pattern） <a class="header-anchor" href="#抽象工厂模式-abstract-factory-pattern" aria-label="Permalink to &quot;抽象工厂模式（Abstract Factory Pattern）&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">public interface Shape {</span></span>
...
<span class="line"><span style="color:#24292e;">computer.accept(new ComputerPartDisplayVisitor());</span></span></code></pre></div>`,90),o=[p];function t(c,r,i,y,d,u){return n(),a("div",null,o)}const h=s(l,[["render",t]]);export{g as __pageData,h as default};
