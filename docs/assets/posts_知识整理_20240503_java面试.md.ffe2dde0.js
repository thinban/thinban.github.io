import{_ as s,o as a,c as e,Q as n}from"./chunks/framework.1eb6b028.js";const b=JSON.parse('{"title":"java面试","description":"流程图、时序图、甘特图等","frontmatter":{"title":"java面试","description":"流程图、时序图、甘特图等","date":"2024-05-03T00:00:00.000Z","tags":["java"]},"headers":[],"relativePath":"posts/知识整理/20240503_java面试.md","filePath":"posts/知识整理/20240503_java面试.md"}'),l={name:"posts/知识整理/20240503_java面试.md"},p=n(`<h2 id="hashmap" tabindex="-1">HashMap <a class="header-anchor" href="#hashmap" aria-label="Permalink to &quot;HashMap&quot;">​</a></h2><p>本质: 数组+链表/红黑树。key/value可以为null。</p><div class="language-txt vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">txt</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">Node&lt;K,V&gt;[] tab</span></span>
...
<span class="line"><span style="color:#24292e;">    afterNodeInsert(eg.remove eldest)</span></span></code></pre></div><h2 id="hashtable" tabindex="-1">HashTable <a class="header-anchor" href="#hashtable" aria-label="Permalink to &quot;HashTable&quot;">​</a></h2><p>扩容：(oldCapacity &lt;&lt; 1) + 1</p><p>线程安全：public synchronized V put(K key, V value) {};</p><h2 id="concurrenthashmap" tabindex="-1">ConcurrentHashMap <a class="header-anchor" href="#concurrenthashmap" aria-label="Permalink to &quot;ConcurrentHashMap&quot;">​</a></h2><p>数据结构：同HashMap(1.8)</p><p>线程安全：乐观锁+Synchronized;哈希桶为空时，线程通过unsafe.compareAndSwapObject比较版本，如果一致则结束线程自旋；哈希桶有值时，则通过Synchronized来保证线程安全。</p><h2 id="arraylist-和-copyonwritearraylist" tabindex="-1">ArrayList 和 CopyOnWriteArrayList <a class="header-anchor" href="#arraylist-和-copyonwritearraylist" aria-label="Permalink to &quot;ArrayList 和 CopyOnWriteArrayList&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">ArrayList </span></span>
...
<span class="line"><span style="color:#24292e;">    CallerRunsPolicy</span></span></code></pre></div><h2 id="spring" tabindex="-1">spring <a class="header-anchor" href="#spring" aria-label="Permalink to &quot;spring&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#e1e4e8;">生命周期</span></span>
