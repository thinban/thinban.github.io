  ...
  themeConfig: {
    ...
    sidebar:
      [
        ...
        { text: 'java', collapsible: true, collapsed: true, items: [{ text: 'dubbo', link: '/java/dubbo.md' }, { text: 'dump文件及分析', link: '/java/dump文件及分析.md' }, { text: 'javacode', link: '/java/javacode.md' }, { text: 'mybatisplus', link: '/java/mybatisplus.md' }, { text: 'spring-cloud', link: '/java/spring-cloud.md' }, { text: 'spring-doc', link: '/java/spring-doc.md' }, { text: 'spring-I18n', link: '/java/spring-I18n.md' }, { text: 'spring-jwt', link: '/java/spring-jwt.md' }, { text: 'spring-mail', link: '/java/spring-mail.md' }, { text: 'spring-validation', link: '/java/spring-validation.md' }, { text: '网关参数', link: '/java/网关参数.md' }] },
        { text: 'mq', collapsible: true, collapsed: true, items: [{ text: 'rocketmq', link: '/mq/rocketmq.md' }] },
        { text: 'network', collapsible: true, collapsed: true, items: [{ text: '制作自签名证书', link: '/network/制作自签名证书.md' }, { text: '网络抓包', link: '/network/网络抓包.md' }] },
