...
export default defineConfig({
  ...
  themeConfig: {
    ...
    [
      ...
      { text: 'infra', collapsible: true, collapsed: true, items: [{ text: 'apollo', link: '/infra/apollo.md' },{ text: 'docker-compose', link: '/infra/docker-compose.md' },{ text: 'docker', link: '/infra/docker.md' },{ text: 'git', link: '/infra/git.md' },{ text: 'nexus', link: '/infra/nexus.md' },{ text: 'nginx', link: '/infra/nginx.md' }] },
      { text: 'interview', collapsible: true, collapsed: true, items: [{ text: 'git', link: '/interview/git.md' },{ text: 'jvm', link: '/interview/jvm.md' },{ text: 'redis', link: '/interview/redis.md' },{ text: '学生答题系统', link: '/interview/学生答题系统.md' }] },
      { text: 'java', collapsible: true, collapsed: true, items: [{ text: 'dubbo', link: '/java/dubbo.md' },{ text: 'dump文件及分析', link: '/java/dump文件及分析.md' },{ text: 'javacode', link: '/java/javacode.md' },{ text: 'mybatisplus', link: '/java/mybatisplus.md' },{ text: 'spring-I18n', link: '/java/spring-I18n.md' },{ text: 'spring-cloud', link: '/java/spring-cloud.md' },{ text: 'spring-doc', link: '/java/spring-doc.md' },{ text: 'spring-jwt', link: '/java/spring-jwt.md' },{ text: 'spring-mail', link: '/java/spring-mail.md' },{ text: 'spring-validation', link: '/java/spring-validation.md' },{ text: '网关参数', link: '/java/网关参数.md' }] },
      { text: 'mq', collapsible: true, collapsed: true, items: [{ text: 'rocketmq', link: '/mq/rocketmq.md' }] },
      { text: 'network', collapsible: true, collapsed: true, items: [{ text: '网络抓包', link: '/network/网络抓包.md' },{ text: '制作自签名证书', link: '/network/制作自签名证书.md' }] },
      { text: 'os', collapsible: true, collapsed: true, items: [{ text: 'disk', link: '/os/disk.md' },{ text: 'linux', link: '/os/linux.md' },{ text: 'macos', link: '/os/macos.md' },{ text: 'shell', link: '/os/shell.md' },{ text: 'windows', link: '/os/windows.md' }] },
      ...
      { text: '.', collapsible: true, collapsed: true, items: [{ text: 'README', link: '/README.md' },{ text: 'index', link: '/index.md' }] },
      ],
    socialLinks: [
